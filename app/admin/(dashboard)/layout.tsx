    ...
    <div className="flex h-screen bg-[#050505] text-white">
      ...
      <main className="flex-1 overflow-y-auto">
        <header className="h-20 border-b border-white/10 bg-[#050505]/50 backdrop-blur-md flex items-center justify-between px-10 sticky top-0 z-10">
          <div className="text-sm font-medium text-[#94a3b8]">Admin Control Panel (DIRECT)</div>
          <div className="flex items-center gap-4">
            <span className="text-xs font-black uppercase tracking-widest text-[#ff5500] bg-[#ff5500]/10 px-3 py-1 rounded-full border border-[#ff5500]/20">
